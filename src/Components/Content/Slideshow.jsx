...
const Slideshow = () => {
  ...
  const content = description === 'OASIS' ? 'Oasis, a vibrant 4-day cultural festival, shines as the hallmark of the odd semester, sometime in October-November. With each passing year, Oasis expands its reach, drawing participants from top colleges across India. Oasis\' creations in its four verticals is fueled by the energy and enthusiasm of new recruits, which has continually elevated department-wide motivation for years together!' : 'APOGEE, a 3-day technical extravaganza, is held in late March/early April in the (conventionally unforgiving) even semester. With every coming year, APOGEE has taken strides to be one of India\'s top technical college festivals. For ADP members, it often scripts the coming-of-age stories of several second and third-yearites, with most of them learning what leadership and motivation is supposed to mean!'
