  ...
  return (
    <div id='Home' className='bg-custom-light text-black dark:bg-custom-dark dark:text-white lg:px-56 lg:py-0 px-10 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center min-h-screen overflow-hidden'>
      <div className='h-full lg:py-40 flex flex-col justify-center lg:items-start items-center'>
        <h1 data-aos='fade-right' style={{ fontFamily: 'Anton' }} className='text-[14px] sm:text-[18px] md:text-[24px] lg:text-[30px] font-bold mb-8 leading-normal uppercase'>
         Welcome To The Department of<br /><span className='text-[30px] sm:text-[38px] md:text-[52px] lg:text-[64px] font-bold mb-8 leading-normal uppercase text-silver-700'> Art, Design and Publicity</span>
        </h1>
