  ...
  return (
    <div id='Home' className='bg-custom-light text-black dark:bg-custom-dark dark:text-white lg:px-40 md:px-24 px-10 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-20 md:gap-16 items-center min-h-screen overflow-hidden'>
      <div className='h-full lg:py-40 md:py-24 flex flex-col justify-center lg:items-start items-center'>
        <h1 data-aos='fade-right' style={{ fontFamily: 'Anton', letterSpacing: 0.8 }} className='text-[16px] sm:text-[18px] md:text-[24px] lg:text-[30px] font-bold mb-8 leading-normal uppercase'>
          Welcome To The Department of<br /><span className='text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[72px] font-bold mb-8 leading-normal uppercase text-silver-700'> Art, Design and Publicity</span>
        </h1>
      ...
      <img data-aos='fade-up' src={img} alt="ADP Logo" className='rounded-full border-2 p-1 border-silver-700 img_glow w-[150px] sm:w-[200px] md:w-[300px] lg:w-[400px] xl:w-[500px] h-auto' />
    </div>
  );
}
