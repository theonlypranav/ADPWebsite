...
function TechStack() {
    ...
    return (
        <div id='Our Team' className='bg-custom-light text-black dark:bg-custom-dark dark:text-white p-10 md:p-20 flex flex-col items-center justify-center'>
          
          <h1 data-aos='fade-right' className='text-[32px] md:text-[72px] font-semibold mb-4 leading-normal uppercase text-silver-700'>
            Our Team
          </h1>
          
          <p data-aos='fade-left' className='text-base md:text-lg mb-20 text-center opacity-0 transition-opacity duration-1000 ease-in-out'>
            ...
            <div className='flex flex-wrap justify-center gap-10 mb-10'>
              {TechStackList.slice(0, 2).map((tech, index) => (
                <div key={index} data-aos={tech.id % 2 === 0 ? 'fade-down' : 'fade-up'} className='flex flex-col items-center'>
                  ...
                  <h2 className='text-[20px] md:text-[32px] font-semibold mt-4 text-center text-silver-700'>{tech.title}</h2>
                  <h3 className='text-[18px] md:text-[28px] font-medium text-center text-silver-500'>{tech.subtitle}</h3>
                </div>
              ))}
            </div>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-10 mb-10'>
              {TechStackList.slice(2, 10).map((tech, index) => (
                <div key={index} data-aos={tech.id % 2 === 0 ? 'fade-down' : 'fade-up'} className='flex flex-col items-center'>
                  ...
                  <h2 className='text-[20px] md:text-[26px] font-semibold mt-4 text-center text-silver-700'>{tech.title}</h2>
                  <h3 className='text-[16px] md:text-[20px] font-medium text-center text-silver-500'>{tech.subtitle}</h3>
                </div>
              ))}
            </div>
          ...
          {selectedItem && (
            <div className='fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50'>
              <div className='relative bg-black rounded-xl overflow-hidden w-full max-w-4xl h-auto max-h-4xl'>
