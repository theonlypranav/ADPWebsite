...
const TeamList = {
  0: {
      ...
      list: ['Ayush Jain','Shlok Jaiswal', 'Sarthak Juneja', 'Archi Patel',  'Aryan Agarwal', 'Samridhhi Sharma','Mann Chhapolia', 'Krish Vora', 'Priyanshu Sinha', 'Manan Gupta', 'Hemanshi Saini', 'Sai Vamsi Addepalli', 'Shelly Paptan']
  },
  1: {
      title: 'Painting',
      picture: ND,
      ...
      list: ['Navya Dhiman', 'Saanidhya Mittal', 'Rakshita Dave', 'Bhoomika Jain', 'Harsh Jha', 'Ria Munshi', 'Shruti Adepu', 'Swarnima Bist', 'Devansh Agarwal', 'Kaustubh Tanwar', 'Lakshit Bansal', 'Navya Jain', 'Urvi Singh', 'Rudr Bisht', 'Kamya Saraogi', 'Siya Bansal']
  },
  2: {
      title: 'Publicity',
      picture: REACT,
      ...
      list: ['Pranav Deshpande', 'Chavi Gupta', 'Aditya Verma', 'Manan Jain', 'Nishkarsh Jain', 'Saaransh Jain', 'Arpit Maity', 'Sajal Batra', 'Krishnansh Sood', 'Unnati Goyal', 'Aurvind Mohanty', 'Aditya Bhusari', 'Harsh Munje', 'Medhansh Adlakha', 'Nakshatra Garg']
  },
  3: {
      title: 'Media',
      picture: REDUX,
      description: 'Media: Media is the newest kid on the block for ADP, but it definitely doesn\'t act like one! With it being formally added only in 2022, it\'s taken huge strides by reaching out to and also forging key collaborations with prominent online and offline News Media houses, newspapers and influencers, contributing to the overall engagement and footfall of the fests.',
      list: ['Sarthak Juneja', 'Archi Patel', 'Pranav Deshpande', 'Bhoomika Jain', 'Saanidhya Mittal', 'Ayush Jain', 'Krish Vora', 'Siya Bansal', 'Swarnima Bist', 'Mann Chhapolia', 'Sai Vamsi Addepalli', 'Lakshit Bansal', 'Krishnansh Sood', 'Devansh Agarwal', 'Aditya Bhusari', 'Rudr Bisht', 'Medhansh Adlakha']
  }
};
