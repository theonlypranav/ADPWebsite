...
const TeamList = {
  0: {
      ...
      list: ['Ayush Jain','Shlok Jaiswal', 'Sarthak Juneja', 'Archi Patel',  'Aryan Agarwal', 'Samriddhi Sharma','Mann Chhapolia', 'Krish Vora', 'Priyanshu Sinha', 'Manan Gupta', 'Hemanshi Saini', 'Sai Vamsi Addepalli', 'Shelly Paptan','Sharayu Musale','Yashas A Ramanujapuram','Asmi Amit Kumar','Hridbeg Choudhary','Rik Sengupta','Sejal Gupta','Prasham Agarwal','Divyam Saini']
  },
  1: {
      title: 'Painting',
      picture: ND,
      ...
      list: ['Navya Dhiman', 'Saanidhya Mittal', 'Rakshita Dave', 'Bhoomika Jain', 'Harsh Jha', 'Ria Munshi', 'Shruthi Adepu', 'Swarnima Bist', 'Devansh Agarwal', 'Kaustubh Tanwar', 'Lakshit Bansal', 'Navya Jain', 'Urvi Singh', 'Rudr Bisht', 'Kamya Saraogi', 'Siya Bansal','Aditi Gupta','Navya Gupta','Janvi Pachisia','Jhanvi Matta','Aditya Chordiya','Aniket Gupta','Amey Sayankar','Tia Chibber','Aadaya Agarwal']
  },
  2: {
      title: 'Publicity',
      picture: REACT,
      ...
      list: ['Pranav Deshpande', 'Chavi Gupta', 'Aditya Raj Verma', 'Manan Jain', 'Nishkarsh Jain', 'Saaransh Jain', 'Arpit Maity', 'Sajal Batra', 'Krishnansh Sood',  'Aurvind Mohanty', 'Aditya Bhusari', 'Harsh Munje', 'Medhansh Adlakha', 'Nakshatara Garg','Agastya Madaan','Anshuman Pathak','Ram Avtar Dube','Aaryan Singh','Shreyansh Jain','Aarna Trivedi','Umit Adalakha','Palak Jha']
  },
  3: {
      title: 'Media',
      picture: REDUX,
