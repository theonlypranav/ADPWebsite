...
const TeamList = {
  0: {
      ...
      list: ['Mann', 'Krish', 'Ayush', 'Sarthak', 'Sajal', 'Priyanshu', 'Manan', 'Archi', 'Shlok', 'Aryan', 'Samridhhi', 'Hemanshi', 'Vamsi', 'Shelly']
  },
  1: {
      title: 'Painting',
      picture: ND,
      ...
      list: ['Navya D.', 'Rakshita', 'Bhoomika', 'Saanidhya', 'Harsh', 'Ria', 'Shruti', 'Swarnima', 'Devansh', 'Kaustubh', 'Lakshit', 'Navya J.', 'Urvi', 'Rudr', 'Kamya', 'Siya']
  },
  2: {
      title: 'Publicity',
      picture: REACT,
      ...
      list: ['Pranav', 'Arpit', 'Sajal', 'Krishnansh', 'Chavi', 'Unnati', 'Aurvind', 'Aditya B.', 'Harsh', 'Aditya V.', 'Manan', 'Nishkarsh', 'Saaransh', 'Yuvraj', 'Medhansh', 'Nakshatra']
  },
  3: {
      title: 'Media',
      picture: REDUX,
